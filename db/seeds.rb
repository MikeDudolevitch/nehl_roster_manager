...
t1.players.build(first_name: "Stan" last_name: "Marsh" primary_position: 14 jersey_number: 12 injured?: false)

t2.players.build(first_name: last_name: primary_position: jersey_number: injured?: )
t2.players.build(first_name: last_name: primary_position: jersey_number: injured?: )
t2.players.build(first_name: last_name: primary_position: jersey_number: injured?: )
t2.players.build(first_name: last_name: primary_position: jersey_number: injured?: )
t2.players.build(first_name: last_name: primary_position: jersey_number: injured?: )
